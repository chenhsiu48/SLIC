...
class Cropout(nn.Module):
    ...
    def __str__(self):
        return f'Cropout({self.height_ratio_range},{self.width_ratio_range})'
    ...
    def forward(self, noised_and_cover):
        ...
        noised_and_cover[0] = noised_image * cropout_mask + torch.zeros_like(cover_image) * (1-cropout_mask)
